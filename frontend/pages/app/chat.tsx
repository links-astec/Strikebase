...
export default function ChatPage() {
  ...
  const send = useCallback(async (text: string) => {
    ...
    const ctx = activeThread.opp
      ? {
          ...
          strike_score:   activeThread.opp.strike_score,
  ...
  return (
    <AuthGuard>
      <Head><title>AI Chat — Strikebase</title></Head>
      <AppShell>
            ...
            {loadingOpp ? (
              ...
              <>
                ...
                <div className="chat-main-hd">
                  ...
                  <span className="chat-aiml-badge">AI/ML API</span>
                </div>
  ...
  return (
    <div className="chat-ctx-inner">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
        <StrikeScore score={opp.strike_score} size="lg" />
        <div>
