          ...
          (function() {
            ...
            function swallow(msg, file) {
              ...
              if (!window.__sb_ext_warned) {
                ...
                console.warn('[Strikebase] Ignored a browser-extension script error (addListener on blob URL). Your app is fine — disable wallet/ad extensions on localhost if you want a clean console.');
              }
              try {
                fetch('http://127.0.0.1:7942/ingest/ea01c433-7ed9-4b61-a6f1-beb757a05458', {
                  ...
                  body: JSON.stringify({
                    sessionId: '0f669a',
                    hypothesisId: 'H1',
                    location: '_document.tsx:head',
                    message: 'extension error swallowed',
                    data: { msg: String(msg).slice(0, 120), file: String(file).slice(0, 120) },
                    timestamp: Date.now(),
                    runId: 'pre-fix',
                  }),
                }).catch(function() {});
