-- Full Strikebase schema — run this once in Supabase SQL Editor
...
CREATE TABLE IF NOT EXISTS opportunities (
  ...
  platform        TEXT,
  snippet         TEXT,
  strike_score    INTEGER DEFAULT 0,
...
-- ── Client profiles (scraped job-poster history) ──────────────────────────────
